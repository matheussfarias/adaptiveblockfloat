# 4 bits, man 1, exp 3
sh end_to_end.sh resnet50 IMAGENET 128 adaptive_block_float 4 1 0
...
# 6 bits, man 3, exp 2
sh end_to_end.sh resnet50 IMAGENET 128 adaptive_block_float 6 3 0
...
# 8 bits, man 4, exp 3
sh end_to_end.sh resnet50 IMAGENET 128 adaptive_block_float 8 4 0
...
sh end_to_end.sh resnet50 IMAGENET 128 adaptive_block_float 16 10 0
...
sh end_to_end.sh resnet50 IMAGENET 128 adaptive_block_float 32 23 0
