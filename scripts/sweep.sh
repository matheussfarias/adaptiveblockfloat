...
echo "resnet50 ..."
time ${script} -n resnet50  -b 128   -d IMAGENET -w 16 -P FP32 -f fp32   #2&> ./log/resnet50_sweep.log
...
#
echo "vit_base ..."
time ${script} -n vit_base  -b 128   -d IMAGENET -w 16 -P FP32 -f fp32   #2&> ./log/vit_bas_sweepe.log
